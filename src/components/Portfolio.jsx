              ...
              return (
                ...
                >
                  ...
                  <div style={port.finished ? { display: 'none' } : null}>
                    <div style={isHovering === port.title ? {opacity: 0.15} : null} className="progress-tag">Work in progress</div>
                    <div style={isHovering === port.title ? {opacity: 0.15} : null} className="progress-tag" />
                  </div>
